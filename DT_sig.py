"""
NG Firewall: Exploit Detected Local to Local Traffic (Custom Origin IP)
triger by source IP

schema to close offences withput event details

Global: Zscaler: Newly Registered Domains Detected
add referer and threshold fields

VPN Login from Non-UK Location
""" 
